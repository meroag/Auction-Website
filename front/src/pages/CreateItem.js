...
function CreateItem() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://auctions-api.stagingzix.xyz/categories/${selectedCategory.id}`).then((rescateg)=>{
    ...
    const handleCloseDialog = () => {
        ...
        axios.post("https://auctions-api.stagingzix.xyz/items", holdData, head).then((res)=>{
