...
function Dashboard() {
    ...
    useEffect(()=>{
            ...
            axios.get(`https://auctions-api.stagingzix.xyz/auth/fetchyall/${id}`).then((response)=>{
                if(response.data.message){
                    ...
                    axios.get(`https://auctions-api.stagingzix.xyz/mail/newmail/${id}`).then((respi)=>{
                    ...
                    axios.get(`https://auctions-api.stagingzix.xyz/items/fetchByUser/${id}`).then((res)=>{
                    ...
                    axios.get(`https://auctions-api.stagingzix.xyz/items/mywatchlist/${id}`).then((resbidy)=>{
