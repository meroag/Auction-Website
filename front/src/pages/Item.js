...
function Item() {
    ...
    const [holdBidData, setHoldBidData ] = useState({});
     ...
     const bidOnIt = () =>{
        ...
        axios.post(`https://auctions-api.stagingzix.xyz/bids/`, holdBidData, head).then((res)=>{
        });
        ...
        axios.post(`https://auctions-api.stagingzix.xyz/history/bid/${itemObject.id}`, body2, head).then((reshi)=>{
        });
    ...
    const buyIt = () =>{
        ...
        if (Math.floor((Date.parse(itemObject.ends)-Date.parse(today)))<=0){
            ...
            axios.put(`https://auctions-api.stagingzix.xyz/items/purchase/${itemObject.id}`, body, head).then((res)=>{
            });
    ...
    const deleteItem = () =>{
        ...
        axios.delete(`https://auctions-api.stagingzix.xyz/items/${itemObject.id}`, head).then((res)=>{
        });
        navigate(`/`);
    };
    ...
    const editItem = (attribute) =>{
     ...
     const switchCategory = () =>{
         ...
         if ((Object.keys(selectedCategory).length > 0 )){
            ...
            axios.put(`https://auctions-api.stagingzix.xyz/items/category/${itemObject.id}`, body, head).then((res)=>{
            });
        ...
        if (locationValue){
            ...
            if ( locationValue === itemObject.location ){
                ...
                if (locationValue!=null){
                    ...
                    axios.put(`https://auctions-api.stagingzix.xyz/items/location/${itemObject.id}`, body, head).then((res)=>{
                    });
    ...
    const switchCoordinates = () =>{
        ...
        if (Object.keys(coordinatesValue).length > 0 ){
            ...
            axios.put(`https://auctions-api.stagingzix.xyz/items/coordinates/${itemObject.id}`, body, head).then((res)=>{
            });
     ...
     const switchName = () =>{
        ...
        if (nameValue){
            ...
            axios.put(`https://auctions-api.stagingzix.xyz/items/name/${itemObject.id}`, body, head).then((res)=>{
            });
     ...
     const switchDescription = () =>{
         ...
         if (descriptionValue){
            ...
            axios.put(`https://auctions-api.stagingzix.xyz/items/description/${itemObject.id}`, body, head).then((res)=>{
            });
    ...
    const switchCountry = () =>{
        if (countryValue){
            ...
            axios.put(`https://auctions-api.stagingzix.xyz/items/country/${itemObject.id}`, body, head).then((res)=>{
            });
        ...
        if (startedValue){
            ...
            if ( Date.parse(startedValue)-Date.parse(new Date()) <= 0 ){
                ...
                if (startedValue!=null){
                    ...
                    axios.put(`https://auctions-api.stagingzix.xyz/items/started/${itemObject.id}`, body, head).then((res)=>{
                    });
        ...
        if (endsValue){
            ...
            if ( Date.parse(endsValue)-Date.parse(new Date()) <= 0 ){
                ...
                if (endsValue!=null){
                    ...
                    // console.log(body);
                    axios.put(`https://auctions-api.stagingzix.xyz/items/ends/${itemObject.id}`, body, head).then((res)=>{
                    });
      ...
      const switchBuyPrice = () =>{
          ...
          if (buyPriceValue){
              ...
              if ( buyPriceValue <= itemObject.currently ){
                ...
                // console.log(body);
                axios.put(`https://auctions-api.stagingzix.xyz/items/buyprice/${itemObject.id}`, body, head).then((res)=>{
                });
          ...
          if (currentlyValue){
              ...
              if ( currentlyValue >= itemObject.buy_price ){
                  ...
                  if (currentlyValue!=null){
                      ...
                      // console.log(body);
                      axios.put(`https://auctions-api.stagingzix.xyz/items/currently/${itemObject.id}`, body, head).then((res)=>{
                      });
    ...
    useEffect(()=>{
        ...
        axios.get(`https://auctions-api.stagingzix.xyz/items/fetchy/${id}`).then((res)=>{
            ...
            axios.get(`https://auctions-api.stagingzix.xyz/photos/${id}`).then((resimag)=>{
                setImages(resimag.data);
            });

            // Then get the categories recursively and return them from parent to children
            axios.get(`https://auctions-api.stagingzix.xyz/categories/${res.data.furthermostCategoryId}`).then((rescateg)=>{
                setCategories(rescateg.data);
            });
            
            // Then get the seller information required
            if (res.data.UserId){
                axios.get(`https://auctions-api.stagingzix.xyz/auth/fetchy/${res.data.UserId}`).then((respo)=>{
            ...
            if (res.data.UserId===authState.id){
                ...
                axios.get(`https://auctions-api.stagingzix.xyz/bids/${id}`).then((response)=>{
                ...
                if (authState && authState.username!== "admin"){
                    ...
                    axios.post(`https://auctions-api.stagingzix.xyz/history/click/${id}`, body, head).then((respirespi)=>{
                    });
